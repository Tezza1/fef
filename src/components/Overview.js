                ...
                <div className="container">
                    <div className="row">
                        <div className="col s12">
                            <h1 className="blue-text darken-5">Framework Overview</h1>
                        </div>
                    </div>
                </div>
                <div className="container">
                                    ...
                                    <div className="card">
                                        ...
                                        <div className="card-stacked">
                                            <div className="card-content">
                                                <span className="card-title">{framework.name}</span>
                                                <p>{framework.description1}</p>
                                                <p>{framework.description2}</p>
                                                <div class="chip">
                                                    <span className="darken-5"><b>Current version:</b></span>  {framework.version}
                                                </div>
                                                <div className="chip">
                                                    <i className="material-icons">star</i> <span className="darken-5"><b>Github stars:</b></span>  {framework.github_stars}
                                                </div>
                                            </div>
                                        </div>
